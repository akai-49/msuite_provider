    ...
    products = {
        "WA": {
            ...
            "features": [
                ...
                {"feature_key": "broadcast", "feature_label": "Broadcast Recipients", "feature_type": "Numeric", "display_order": 5},
                {"feature_key": "team_inbox", "feature_label": "Shared Team Inbox", "feature_type": "Boolean", "display_order": 6},
    ...
    wa_plans = [
        {
            ...
            "features": {
                "messaging": (True, 100, "per month"), "templates": (True, 3, "total"),
                "calling": (False, None, None), "flows": (False, None, None),
                "broadcast": (False, None, None), "team_inbox": (False, None, None),
                "chatbot": (False, None, None), "analytics": (True, None, None),
            },
            "grants": [],
        },
        {
            ...
            "features": {
                "messaging": (True, 1000, "per month"), "templates": (True, 5, "total"),
                "calling": (False, None, None), "flows": (False, None, None),
                "broadcast": (False, None, None), "team_inbox": (False, None, None),
                "chatbot": (False, None, None), "analytics": (True, None, None),
            },
        ...
        },
        {
            ...
            "features": {
                "messaging": (True, 5000, "per month"), "templates": (True, 25, "total"),
                "calling": (True, None, None), "flows": (True, 3, "total"),
                "broadcast": (True, 5000, "per campaign"), "team_inbox": (True, None, None),
                "chatbot": (False, None, None), "analytics": (True, None, None),
            },
            "grants": [],
        },
        {
            ...
            "features": {
                "messaging": (True, None, "per month"), "templates": (True, 100, "total"),
                "calling": (True, None, None), "flows": (True, 10, "total"),
                "broadcast": (True, 50000, "per campaign"), "team_inbox": (True, None, None),
                "chatbot": (True, None, None), "analytics": (True, None, None),
            },
        ...
        },
        {
            ...
            "features": {
                "messaging": (True, None, "per month"), "templates": (True, None, "total"),
                "calling": (True, None, None), "flows": (True, None, "total"),
                "broadcast": (True, None, "per campaign"), "team_inbox": (True, None, None),
                "chatbot": (True, None, None), "analytics": (True, None, None),
            },
