...
SOCIAL_PRODUCT_FEATURES = [
    ...
    {"feature_key": "analytics_agent",        "feature_label": "Analytics Agent",        "feature_type": _FEATURE_TYPE_BOOLEAN, "display_order": 25},
...
SOCIAL_PLAN_FEATURES = {
    "SOCIAL-TRIAL": {
        ...
        "analytics_agent":        (False, None, None),
    ...
    "SOCIAL-PRO": {
        ...
        "social_bulk_posts":      (False, None, None),
        "analytics_agent":        (True,  None, None),
