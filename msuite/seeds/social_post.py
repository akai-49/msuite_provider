...
SOCIAL_PRODUCT_FEATURES = [
    ...
    {"feature_key": "ai_analytics_bot",       "feature_label": "AI Analytics Bot",       "feature_type": _FEATURE_TYPE_BOOLEAN, "display_order": 25},
...
SOCIAL_PLAN_FEATURES = {
    "SOCIAL-TRIAL": {
        ...
        "ai_analytics_bot":       (False, None, None),
    ...
    "SOCIAL-PRO": {
        ...
        "social_bulk_posts":      (False, None, None),
        "ai_analytics_bot":       (True,  None, None),
