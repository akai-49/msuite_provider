"""
Reseed the Inbox product + plans in-place (v2, to ensure INBOX-ENT exists).
"""
import frappe
...
def _ensure_item(plan_cfg: dict) -> None:
    ...
    # Ensure the 'Inbox' Item Group exists.
    if not frappe.db.exists("Item Group", "Inbox"):
        doc = frappe.new_doc("Item Group")
        doc.item_group_name = "Inbox"
